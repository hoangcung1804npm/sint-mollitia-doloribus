[![npm](https://img.shields.io/npm/v/@hoangcung1804npm/sint-mollitia-doloribus.svg)](https://www.npmjs.com/package/@hoangcung1804npm/sint-mollitia-doloribus) ![downloads](https://img.shields.io/npm/dt/@hoangcung1804npm/sint-mollitia-doloribus.svg) [![CI](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/actions/workflows/ci.yml/badge.svg)](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/actions)
...
This package is used to _display_ existing PDFs. If you wish to _create_ PDFs using React, you may be looking for [@@hoangcung1804npm/sint-mollitia-doloribus/renderer](https://www.npmjs.com/package/@@hoangcung1804npm/sint-mollitia-doloribus/renderer).

## tl;dr

- Install by executing `npm install @hoangcung1804npm/sint-mollitia-doloribus` or `yarn add @hoangcung1804npm/sint-mollitia-doloribus`.
- Import by adding `import { Document } from '@hoangcung1804npm/sint-mollitia-doloribus'`.
...
[Online demo](https://projects.wojtekmaj.pl/@hoangcung1804npm/sint-mollitia-doloribus/) is also available!
...
- [v6.x](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/blob/v6.x/README.md)
- [v5.x](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/blob/v5.x/README.md)
- [v4.x](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/blob/v4.x/README.md)
- [v3.x](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/blob/v3.x/README.md)
- [v2.x](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/blob/v2.x/README.md)
- [v1.x](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/blob/v1.x/README.md)
...
Add React-PDF to your project by executing `npm install @hoangcung1804npm/sint-mollitia-doloribus` or `yarn add @hoangcung1804npm/sint-mollitia-doloribus`.
...
```ts
import { pdfjs } from '@hoangcung1804npm/sint-mollitia-doloribus';
...
import { Document, Page } from '@hoangcung1804npm/sint-mollitia-doloribus';
...
Check the [sample directory](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/tree/main/sample) in this repository for a full working example. For more examples and more advanced use cases, check [Recipes](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/wiki/Recipes) in [React-PDF Wiki](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/wiki/).
...
```ts
import '@hoangcung1804npm/sint-mollitia-doloribus/dist/Page/AnnotationLayer.css';
```
...
```ts
import '@hoangcung1804npm/sint-mollitia-doloribus/dist/Page/TextLayer.css';
```
...
| ------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className          | Class name(s) that will be added to rendered element along with the default `@hoangcung1804npm/sint-mollitia-doloribus__Document`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | n/a                                                   | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                   |
...
| className                      | Class name(s) that will be added to rendered element along with the default `@hoangcung1804npm/sint-mollitia-doloribus__Page`.                                                                                                                                                                                                   | n/a                                                 | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                 |
...
| Prop name     | Description                                                                                                                                        | Default value | Example values                                                                                                                                                                                                                                                              |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className     | Class name(s) that will be added to rendered element along with the default `@hoangcung1804npm/sint-mollitia-doloribus__Outline`.                                                  | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul>                                                                                                                  |
...
| Prop name   | Description                                                                                                                                  | Default value | Example values                                                                                                                                             |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------- | ------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |
| className   | Class name(s) that will be added to rendered element along with the default `@hoangcung1804npm/sint-mollitia-doloribus__Thumbnail`.                                          | n/a           | <ul><li>String:<br />`"custom-class-name-1 custom-class-name-2"`</li><li>Array of strings:<br />`["custom-class-name-1", "custom-class-name-2"]`</li></ul> |
...
- [React-PDF Wiki](https://github.com/hoangcung1804npm/sint-mollitia-doloribus/wiki/)
...
Thank you to all our sponsors! [Become a sponsor](https://opencollective.com/@hoangcung1804npm/sint-mollitia-doloribus-wojtekmaj#sponsor) and get your image on our README on GitHub.

<a href="https://opencollective.com/@hoangcung1804npm/sint-mollitia-doloribus-wojtekmaj#sponsors" target="_blank"><img src="https://opencollective.com/@hoangcung1804npm/sint-mollitia-doloribus-wojtekmaj/sponsors.svg?width=890"></a>

### Backers

Thank you to all our backers! [Become a backer](https://opencollective.com/@hoangcung1804npm/sint-mollitia-doloribus-wojtekmaj#backer) and get your image on our README on GitHub.

<a href="https://opencollective.com/@hoangcung1804npm/sint-mollitia-doloribus-wojtekmaj#backers" target="_blank"><img src="https://opencollective.com/@hoangcung1804npm/sint-mollitia-doloribus-wojtekmaj/backers.svg?width=890"></a>

### Top Contributors

Thank you to all our contributors that helped on this project!

![Top Contributors](https://opencollective.com/@hoangcung1804npm/sint-mollitia-doloribus/contributors.svg?width=890&button=false)
